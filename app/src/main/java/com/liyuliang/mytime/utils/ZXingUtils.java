...
public class ZXingUtils {
     ...
     *
     * @param content     文本内容
     * @param highQuality 是否是高质量的（高容错率）
     * @param width       宽度
     * @param height      高度
     * @return 二维码bitmap
     */
    public static Bitmap createQRImage(String content, boolean highQuality, int width, int height) {
        try {
            // 判断内容是否为空
            ...
            hints.put(EncodeHintType.ERROR_CORRECTION, highQuality ? ErrorCorrectionLevel.H : ErrorCorrectionLevel.L);
     ...
     */
    public static boolean createQRImage(Context context, String content, boolean highQuality, int widthPix, int heightPix, Bitmap logoBm, String filePath) {
        try {
