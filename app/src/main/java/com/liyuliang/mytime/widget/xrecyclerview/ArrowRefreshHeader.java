package com.liyuliang.mytime.widget.xrecyclerview;
...
import com.liyuliang.mytime.widget.xrecyclerview.progressindicator.AVLoadingIndicatorView;
...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	public void refreshComplete(){
        ...
        setState(STATE_DONE);
        new Handler().postDelayed(this::reset, 200);
	}
