package com.liyuliang.mytime.widget.pickerview.view;

import android.graphics.Typeface;
import android.view.View;

import com.liyuliang.mytime.R;
import com.liyuliang.mytime.widget.pickerview.adapter.ArrayWheelAdapter;
import com.liyuliang.mytime.widget.pickerview.listener.OnOptionsSelectChangeListener;
import com.liyuliang.mytime.widget.pickerview.listener.OnItemSelectedListener;

import java.util.List;

public class WheelOptions<T> {
    private View view;
    private final WheelView wv_option1,wv_option2,wv_option3;
    ...
    public void setPicker(List<T> options1Items,
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    ...
                    if (!isRestoreItem) {
                        ...
                        opt3 = Math.min(wv_option3.getCurrentItem(), mOptions3Items.get(opt1Select).get(index).size() - 1);
                    }
        ...
        if (options3Items != null && linkage && optionsSelectChangeListener != null) {
            wv_option3.setOnItemSelectedListener(index -> optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), wv_option2.getCurrentItem(), index));
        }
    }
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        if (optionsSelectChangeListener != null) {
            wv_option1.setOnItemSelectedListener(index -> optionsSelectChangeListener.onOptionsSelectChanged(index, wv_option2.getCurrentItem(), wv_option3.getCurrentItem()));
        }
        ...
        if (options2Items == null) {
            ...
            wv_option2.setVisibility(View.VISIBLE);
            if (optionsSelectChangeListener != null) {
                wv_option2.setOnItemSelectedListener(index -> optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), index, wv_option3.getCurrentItem()));
            }
        }
        if (options3Items == null) {
            wv_option3.setVisibility(View.GONE);
